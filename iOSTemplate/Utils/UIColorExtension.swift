...
extension UIColor {
    ...
    static var primaryColor: UIColor { UIColor(named: "AccentColor") ?? #colorLiteral(red: 0.9529411765, green: 0.7450980392, blue: 0.2784313725, alpha: 1) }
    static var secondaryColor: UIColor { .black }
    
    static var titleColor: UIColor { UIColor(named: "titleColor") ?? #colorLiteral(red: 0.3058823529, green: 0.3058823529, blue: 0.3058823529, alpha: 1) }
    static var subtitleColor: UIColor { UIColor(named: "subtitleColor") ?? #colorLiteral(red: 0.4588235294, green: 0.4588235294, blue: 0.4588235294, alpha: 1) }
    static var contentColor: UIColor { UIColor(named: "contentColor") ?? #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1) }
    
    static var navigationBarBackgroundColor: UIColor { .primaryColor }
    static var navigationBarTintColor: UIColor { .secondaryColor }
    static var tabBarTintColor: UIColor { UIColor(named: "tabBarTintColor") ?? .white }
